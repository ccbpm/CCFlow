    ...
    <table border="1" widht='90%'>
        ...
        <tr>
            <td>
                <% if (dr["Type"] + "" == "RUNNING")
                   { %>
                <a href="../WF/WFRpt.htm?FK_Flow=<%=dr["FK_Flow"] %>&WorkID=<%=dr["WorkID"] %>" target="_blank">
                    <%=dr["Title"]%>
                </a>
                <% }
                   else
            ...
            <% if (dr["Type"] + "" == "RUNNING")
               { %>
            <td>
                <a href="../WF/MyFlow.htm?FK_Flow=<%= dr["FK_Flow"] %>&CopyFormWorkID=<%= dr["WorkID"] %>&CopyFormNode=<%= dr["FK_Node"] %>"
