    ...
    <script type="text/javascript">
        ...
        function UnSend(appPath, fk_flow, workid) {
            if (window.confirm('您确定要撤销本次发送吗？') == false)
                return;
            var url = '../WF/Do.aspx?DoType=UnSend&WorkID=' + workid + '&FK_Flow=' + fk_flow;
            window.location.href = url;
            return;
        }
        function Press(appPath, fk_flow, workid) {
            var url =  '../WF/WorkOpt/Press.htm?WorkID=' + workid + '&FK_Flow=' + fk_flow;
        ...
        function CopyAndStart(appPath, fk_flow, CopyFormNode, CopyFormWorkID) {
            var url =  '../WF/MyFlow.aspx?CopyFormWorkID=' + CopyFormWorkID + '&CopyFormNode=' + CopyFormNode + '&FK_Flow=' + fk_flow;
