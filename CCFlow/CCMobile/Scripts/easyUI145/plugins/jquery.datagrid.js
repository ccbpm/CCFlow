...
var th=$(this);
var col=$.extend({},$.parser.parseOptions(this,["id","field","align","halign","order","width",{sortable:"boolean",checkbox:"boolean",resizable:"boolean",fixed:"boolean"},{rowspan:"number",colspan:"number"}]),{title:(th.html()||undefined),hidden:(th.attr("hidden")?true:undefined),formatter:(th.attr("formatter")?cceval(th.attr("formatter")):undefined),styler:(th.attr("styler")?cceval(th.attr("styler")):undefined),sorter:(th.attr("sorter")?cceval(th.attr("sorter")):undefined)});
...
_61[0].onclick=cceval(btn.handler||function(){
});
