...
<body class="easyui-layout">
        ...
        <div id="addEmptt" class="easyui-tabs" style="width: auto; height: 440px; border: 0px;" data-options="border:false">
            <div title="基本信息" style="padding: 20px;">
                <table cellpadding="3">
                    ...
                    <tr>
                        <td class="tableLabel">签ww字类型:</td>
                        <td colspan=1>
                            <select id="SignTypeNew" class="easyui-textbox"  data-options="editable:false"  name="SignTypeNew">
                             <option value='0'> 不签名</option>
                             <option value='1'> 图片签名</option>
                          ...
                          <td class="tableLabel">身份证号:</td>
                        <td>
                            <input id="TB_PersonalID" class="easyui-textbox" type="text" name="TB_PersonalID"/>
                        </td>
    ...
    <div id="mEmp" class="easyui-menu" style="width: 120px;">
        ...
        <div data-options="iconCls:'icon-up'" onclick="EmpFloatNode('up')">上移</div>
        <div data-options="iconCls:'icon-down'" onclick="EmpFloatNode('down')">下移</div>
        ...
        <div id="emptt" class="easyui-tabs" style="width: auto; height: 430px; border: 0px;"
            ...
            <div title="基本信息" data-options="iconCls:'icon-3'" style="padding-top: 40px; margin-left:10px;" align="left">
                <table cellpadding="3" width="100%">
                    ...
                    <tr>
                        <td class="tableLabel">签字类型:</td>
                        <td colspan=1>
                            <select id="SignType" class="easyui-textbox"  name="SignType">
                             <option value='0'> 不签名</option>
                             <option value='1'> 图片签名</option>
                             <option value='2'> 电子签名</option>
                            </select>
                            
                            <a href="javascript:SetSiganture()">设置图片签名</a>

                        </td>

                         <td class="tableLabel">身份证号:</td>
                        <td>
                            <input id="setPersonalID" class="easyui-textbox" type="text" name="setPersonalID" />
                        </td>
    ...
    <div id="connecteEmp" class="easyui-dialog" style="overflow: hidden;">
        ...
        <div id="glryTb">
            <input id="connecteEmp_shareText" class="easyui-textbox" type="text" style=" height:18px;"/>
            <a href="#" id="A1" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-search'" onclick="connecteEmpSearchByNameOrDept(1,20)">查询</a>
