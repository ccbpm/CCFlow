...
namespace CCFlow.App.Portal
{
    ...
    public partial class GuideWeiXin : System.Web.UI.Page
    {
        public void DoYiChang()
        {
            ...
            BP.Cloud.Emp emp = new BP.Cloud.Emp(gwf.OrgNo + "_" + gwl.EmpNo);
            ...
            if (gwf.WFState == WFState.Complete)
            {
                if (this.IsMobile == false)
                    url = "/WF/MyView.htm?WorkID=" + workid + "&FK_Flow=" + gwf.FlowNo + "&FK_Node=" + gwf.NodeID;
                else
                    url = "/CCMobile/MyView.htm?WorkID=" + workid + "&FK_Flow=" + gwf.FlowNo + "&FK_Node=" + gwf.NodeID;
