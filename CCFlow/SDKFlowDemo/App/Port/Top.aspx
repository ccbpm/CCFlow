<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Top.aspx.cs" Inherits="CCFlow.WF.App.Classic.TopSDK" %>
...
<body>
<div class="top">
 <div class="logo"><%=BP.Sys.SystemConfig.SysName %></div>  
 <div class="logo_cz"> 
  <div class="logo_cz1">
 <ul>
    <li>账号：<%=BP.Web.WebUser.No %></li>
    <li>姓名：<%=BP.Web.WebUser.Name %></li>
