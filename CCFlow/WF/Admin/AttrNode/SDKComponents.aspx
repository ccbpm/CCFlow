...
<% 
    ...
    string src = "../../Comm/RefFunc/UIEn.aspx?EnName=FrmWorkCheck&PK="+nodeID;
    ...
    BP.WF.Node nd = new BP.WF.Node(fk_node);
     %>
     <ul>
        <li> <a href="../../Comm/RefFunc/UIEn.aspx?EnName=FrmWorkCheck&PK=<%=nodeID %>" target="Doc" >审核组件</a> </li>
        ...
        <li> <a href="../../Comm/RefFunc/UIEn.aspx?EnName=FrmWorkCheck&PK=<%=nodeID %>" target="Doc">轨迹</a> </li>
        ...
        <% if (nd.HisNodeWorkType == BP.WF.NodeWorkType.WorkHL || nd.HisNodeWorkType == BP.WF.NodeWorkType.WorkFHL)
           { %>
          <li> <a href="../../Comm/RefFunc/UIEn.aspx?EnName=FrmWorkCheck&PK=<%=nodeID %>" target="Doc">子线程</a> </li>
         <%} %>
     </ul>
 </td>
