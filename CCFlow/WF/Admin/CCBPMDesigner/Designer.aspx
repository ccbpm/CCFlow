...
<body id="body">
    <div id="actions">
        ...
        <img class="separator" src="assets/images/toolbar_separator.gif" border="0" width="1" height="18" alt="自定义流程报表." />
        <a style="text-decoration: none;" href="javascript:DesignMyRptNew();" title="报表设计">
            <img src="Img/DesignRpt.png"   id="DesignMyRptNew"   border="0" width="14" height="14" alt="报表设计" />
            <label for="DesignMyRptNew" class="toolbarText">报表New</label>
        </a>
