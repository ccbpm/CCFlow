<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Welcome.aspx.cs" Inherits="CCFlow.WF.Admin.CCBPMDesigner.Welcome" %>
        ...
        <tr>
            ...
            <td valign="top">
                <fieldset>
                    <legend>更多资源</legend>
                    <ul style="list-style: none">
                        <li><a href="http://bbs.ccflow.org/posttopic.aspx?forumid=7&forumpage=1" target="_blank">
                            提问</a>-<a href="http://bbs.ccflow.org/posttopic.aspx?forumid=11&forumpage=1" target="_blank">Bug,建议</a>-<a
                                href="http://bbs.ccflow.org/posttopic.aspx?forumid=11&forumpage=1" target="_blank">有偿服务</a></li>
                        ...
                        <%--  <li><a href="../../../WF/KeySearch.aspx">
                            <img src="./Img/RptOrder.png" border="0" />&nbsp;数据报表订阅</a></li>--%>
                    </ul>
                </fieldset>
            </td>
        </tr>
