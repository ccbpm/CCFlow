...
function InitBar(optionKey) {
    ...
    if (frmWorkModel == 1) {
        ...
        html += "<option value=" + FormSlnType.FoolForm + ">&nbsp;&nbsp;傻瓜模式(默认)</option>";
    ...
    html += "<option value=" + FormSlnType.FoolForm + ">&nbsp;&nbsp;内置傻瓜表单(默认)</option>";
    html += "<option value=" + FormSlnType.FreeForm + ">&nbsp;&nbsp;内置自由表单</option>";
  //  html += "<option value=" + FormSlnType.FoolTruck + " >&nbsp;&nbsp;内置累加模式表单</option>";
   // html += "<option value=" + FormSlnType.WebOffice + "  >&nbsp;&nbsp;公文表单(weboffice)</option>";
  ...
  //  html += "<option value=" + FormSlnType.SDKForm + " >&nbsp;&nbsp;SDK表单(我自定义的表单)</option>";
    ...
    html += "<option value=" + FormSlnType.RefOneFrmTree + " >&nbsp;&nbsp;VSTO模式Excel表单</option>";
    html += "<option value=" + FormSlnType.SheetTree + " >&nbsp;&nbsp;Word表单</option>";
    html += "</select >";
