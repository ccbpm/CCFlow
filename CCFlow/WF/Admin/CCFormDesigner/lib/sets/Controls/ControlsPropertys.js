...
CCForm_Control_Propertys = {
    TextBox_Str: [{ proName: 'FieldText', ProText: '中文名', DefVal: 'FieldText', DType: 'string', ProType: BuilderProperty.TYPE_SINGLE_TEXT_ReadOnly },
                  ...
                  { proName: 'WinPOP', ProText: '设置开窗返回值', DefVal: '/WF/MapDef/MapExt/PopVal.aspx?FK_MapData=@NodeID@&RefNo=@KeyOfEn@&MyPK=PopVal_@NodeID@_@KeyOfEn@', DType: 'href', ProType: BuilderProperty.CCFormLink },
                  { proName: 'Expression', ProText: '正则表达式', DefVal: '/WF/MapDef/MapExt/RegularExpression.aspx?FK_MapData=@NodeID@&RefNo=@KeyOfEn@&OperAttrKey=@NodeID@_@KeyOfEn@', DType: 'href', ProType: BuilderProperty.CCFormLink },
                  { proName: 'TBFullCtrl', ProText: '文本框自动完成', DefVal: '/WF/MapDef/MapExt/TBFullCtrl.aspx?FK_MapData=@NodeID@&RefNo=@KeyOfEn@&MyPK=@NodeID@_TBFullCtrl_@KeyOfEn@', DType: 'href', ProType: BuilderProperty.CCFormLink },
                  { proName: 'AotuGenerNo', ProText: '自动生成编号', DefVal: '/WF/MapDef/MapExt/AotuGenerNo.aspx?FK_MapData=@NodeID@&RefNo=@KeyOfEn@', DType: 'href', ProType: BuilderProperty.CCFormLink },
                  { proName: 'AutoFull', ProText: '获取外部数据', DefVal: '/WF/MapDef/MapExt/AutoFull.aspx?FK_MapData=@NodeID@&ExtType=AutoFull&RefNo=@NodeID@_@KeyOfEn@', DType: 'href', ProType: BuilderProperty.CCFormLink },
                  { proName: 'EleBatch', ProText: '批量复制更新删除控件', DefVal: '/WF/MapDef/EleBatch.aspx?KeyOfEn=@KeyOfEn@&FK_MapData=@NodeID@&EleType=MapAttr', DType: 'href', ProType: BuilderProperty.CCFormLink }
                  ],
    TextBox_Int: [{ proName: 'FieldText', ProText: '字段中文名', DType: 'string', ProType: BuilderProperty.TYPE_SINGLE_TEXT },
                  { proName: 'KeyOfEn', ProText: '字段英文名', DType: 'string', ProType: BuilderProperty.TYPE_SINGLE_TEXT },
                  { proName: 'DefVal', ProText: '默认值', DType: 'enum', ProType: BuilderProperty.CCFormEnum },
                  ...
                  { proName: 'MinLen', ProText: '最小长度', DType: 'int', ProType: BuilderProperty.TYPE_SINGLE_TEXT },
                  { proName: 'MaxLen', ProText: '最大长度', DType: 'int', ProType: BuilderProperty.TYPE_SINGLE_TEXT },
                  { proName: 'UIWidth', ProText: '文本框宽度', DType: 'int', ProType: BuilderProperty.TYPE_SINGLE_TEXT },
                  { proName: 'UIHeight', ProText: '高度', DType: 'int', ProType: BuilderProperty.TYPE_SINGLE_TEXT }
                 ],
    TextBox_Float: { height: 30, Width: 23 },
    TextBox_Money: { height: 30, Width: 23 },
    TextBox_Date: { height: 30, Width: 23 },
    TextBox_DateTime: { height: 30, Width: 23 },
    TextBox_Boolean: { height: 30, Width: 23 }
};