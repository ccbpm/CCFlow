...
{
    public partial class PriFlowTemImp : WebPage
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable dt = ccflowCloud.GetPriFlowTemplateByGuid(guid);

                byte[] bytes = ccflowCloud.GetFlowXML(false, guid);

                string path = BP.Sys.SystemConfig.PathOfDataUser + "CloundFlow\\private";
                ...
                path = BP.Sys.SystemConfig.PathOfDataUser + "CloundFlow\\private\\" + fileName;
