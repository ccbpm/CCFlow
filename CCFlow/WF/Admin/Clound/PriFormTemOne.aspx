<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PriFormTemOne.aspx.cs"
    Inherits="CCFlow.WF.Admin.Clound.PriFormTemOne" %>
...
<body>
    ...
    <% 
        ...
        try
        {
            dt = ccflowCloud.GetPriFormTemplateByGuid(guid);
        }
        catch (Exception)
        {
                ...
                <fieldset>
                    <legend>操作</legend><a href="?DoType=Download&GUID=<%=guid %>">
                        <%
                            ...
                            {
                                byte[] bytes = ccflowCloud.GetFormData(false, guid);
                    ...
                    <%--|<a href="TempleteFlowImp.aspx?GUID=<%=guid %>"><img
                            src="imgs/ImportFlow.png" border="0" />导入表单</a>--%>
                </fieldset>
                <fieldset>
                    <legend>基本信息</legend>
                    <table>
