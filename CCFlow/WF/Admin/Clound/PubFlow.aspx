<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PubFlow.aspx.cs" Inherits="CCFlow.WF.Admin.Clound.PubFlow" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $("#pageloading").show();
            loadTreeData();
            met = "getRecentlyFlowTemp";
            LoadGridData(1, 20);
        });
        function loadTreeData() {
            var params = {
                method: "getFlowTreeJSON"
            };
        ...
        function rowDetail(no, name) {
            ...
            window.parent.addTab('PubFlowTemOne', '流程信息', '../../../WF/Admin/Clound/PubFlowTemOne.aspx?GUID=' + no, '');
        }
        function LoadDataGridCallBack(js, scorp) {
            ...
            $('#newsGrid').datagrid({
                ...
                onClickRow: function (rowIndex, rowData) {
                    //window.parent.closeTab('流程信息');
                    //window.parent.addTab('TempleteFlowOne', '流程信息', '../../../WF/Admin/Clound/TempleteFlowOne.aspx?GUID=' + rowData.NO, '');
                },
                loadMsg: '数据加载中......'
            });
            //分页
