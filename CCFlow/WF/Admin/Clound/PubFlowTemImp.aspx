<%@ Page Title="流程导入" Language="C#" MasterPageFile="~/WF/Admin/WinOpen.master" AutoEventWireup="true"
    CodeBehind="PubFlowTemImp.aspx.cs" Inherits="CCFlow.WF.Admin.AttrFlow.PubFlowTemImp" %>
                ...
                <fieldset>
                    ...
                    <ul style="list-style: none;">
                        <li>
                            ...
                            指定的流程编号:<asp:TextBox ID="SpecifiedNumber" runat="server"></asp:TextBox> <font color="red">如果导入将会被覆盖该流程。</a>
