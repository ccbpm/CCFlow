<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PubFlowTemOne.aspx.cs"
    Inherits="CCFlow.WF.Admin.Clound.PubFlowTemOne" %>
...
<body>
    ...
    <% 
        ...
        try
        {
            dt = ccflowCloud.GetFlowTemplateByGuid(guid);
        }
        catch (Exception)
        {
            ...
            <td valign="top" width="42%">
                <fieldset>
                    <legend>操作</legend><a href="?DoType=Download&GUID=<%=guid %>">
                        ...
                        %>
                        <img src="imgs/Download.png" border="0" />下载到本机</a> |<a href="PubFlowTemImp.aspx?GUID=<%=guid %>"><img
                            src="imgs/ImportFlow.png" border="0" />导入流程</a>| <a href="SaveFlowToPriTem.aspx?GUID=<%=guid %>">
