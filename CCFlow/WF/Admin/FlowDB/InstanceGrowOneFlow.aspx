<%@ Page Title="实例增长分析" Language="C#" MasterPageFile="~/WF/Admin/WinOpen.master"
    AutoEventWireup="true" CodeBehind="InstanceGrowOneFlow.aspx.cs" Inherits="CCFlow.WF.Admin.FlowDB.InstanceGrowOneFlow" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function loadFlowUSLChartType() {
            ...
            window.location.href = "InstanceGrowOneFlow.aspx?anaTime=" + str1 + "&FK_Flow=" + fk_flow + "&";
        }
    </script>
</asp:Content>
                ...
                <fieldset>
                    ...
                    <table style="width: 80%;">
                        ...
                        <tr>
                            ...
                            <td>
                                <%=BP.DA.DBAccess.RunSQLReturnValInt("SELECT COUNT(WorkID) FROM WF_GenerWorkFlow WHERE FK_Flow=" + fk_flow + "   AND WFState!=" + (int)BP.WF.WFState.Complete + " ")%>
                            </td>
                            <td>
                                个
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <%=BP.DA.DBAccess.RunSQLReturnValInt("SELECT COUNT(WorkID) FROM WF_GenerWorkFlow WHERE FK_Flow=" + fk_flow + "   AND WFState=" + (int)BP.WF.WFState.ReturnSta + "   ")%>
                            </td>
                            <td>
                                个
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <%=BP.DA.DBAccess.RunSQLReturnValInt("SELECT COUNT(WorkID) FROM WF_GenerWorkFlow WHERE FK_Flow=" + fk_flow + "   AND WFState=" + (int)BP.WF.WFState.Delete + " ")%>
                            </td>
                            <td>
                                个
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <%=BP.DA.DBAccess.RunSQLReturnValInt("SELECT COUNT(WorkID) FROM WF_GenerWorkFlow WHERE FK_Flow=" + fk_flow + "   AND WFSta=" + (int)BP.WF.WFSta.Etc + " ")%>
                            </td>
                            <td>
                                个
                            </td>
                ...
                <fieldset>
                    ...
                    <table style="width: 80%;">
                        ...
                        <tr>
                            ...
                            <td>
                                <%=BP.DA.DBAccess.RunSQLReturnValInt("SELECT COUNT(WorkID) FROM WF_GenerWorkFlow WHERE FK_Flow=" + fk_flow + "   AND WFState!=" + (int)BP.WF.WFState.Complete + " AND  FK_NY='" + FK_NY + "' ")%>
                            </td>
                            <td>
                                个
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <%=BP.DA.DBAccess.RunSQLReturnValInt("SELECT COUNT(WorkID) FROM WF_GenerWorkFlow WHERE FK_Flow=" + fk_flow + "   AND WFState=" + (int)BP.WF.WFState.ReturnSta + " AND  FK_NY='" + FK_NY + "'  ")%>
                            </td>
                            <td>
                                个
                            </td>
                ...
                <fieldset>
                    ...
                    <table style="width: 80%;">
                        ...
                        <tr>
                            ...
                            <td>
                                <%=BP.DA.DBAccess.RunSQLReturnValInt("SELECT COUNT(WorkID) FROM WF_GenerWorkFlow WHERE FK_Flow=" + fk_flow + "   AND WFState!=" + (int)BP.WF.WFState.Complete + " AND WeekNum=" + priWeek)%>
                            </td>
                            <td>
                                个
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <%=BP.DA.DBAccess.RunSQLReturnValInt("SELECT COUNT(WorkID) FROM WF_GenerWorkFlow WHERE FK_Flow=" + fk_flow + "   AND WFState=" + (int)BP.WF.WFState.ReturnSta + " AND   WeekNum=" + priWeek)%>
                            </td>
                            <td>
                                个
                            </td>
                    ...
                    switch (anaTime)
                    {
                        case "mouth":
                            sql = "select  COUNT(DeptName) Num, DeptName from WF_GenerWorkFlow" +
                                  "  where FK_Flow=" + fk_flow + "   AND FK_NY='" + dTime.ToString("yyyy-MM") + "' group  by DeptName";
