<%@ Page Title="" Language="C#" MasterPageFile="~/WF/Admin/FoolFormDesigner/WinOpen.master" AutoEventWireup="true" CodeBehind="TBFullCtrl.aspx.cs" Inherits="CCFlow.WF.MapDef.TBFullCtrlNew" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

<table style=" width:100%;">
<caption>为文本框【<%=this.Request.QueryString["RefNo"] %>】设置自动填充 </caption>
<tr>
<td class="Idx">1</td>
...
<td colspan="3">
    ...
    <asp:Button ID="Btn_FullDtl" runat="server" Text="填充从表" ToolTip="当数据填充后，需要改变指定的从表数据。比如：主表选择人员，从表人员简历信息。" OnClick="Btn_FullDtl_Click"  />
    <asp:Button ID="Btn_FullDDL" runat="server" Text="填充下拉框"  ToolTip="当数据填充后，需要改变指定的下拉框内容。比如：选择人员后，有一个人员岗位的下拉框，该下拉框的内容仅仅需要显示人员岗位。" OnClick="Btn_FullDDL_Click"  />
