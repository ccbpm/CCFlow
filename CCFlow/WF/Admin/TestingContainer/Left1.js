...
function InitPageUserInfo() {
    ...
    var html = "<table class=Table style='width:100%;margin:13px;padding:4px;'>";
    ...
    html += "<li style='padding:5px;'><a href='javaScript:SelectOneUser()'  class='J_menuItem' >切换用户</a></li>";
...
{
    var url = "SelectOneUser.html?Adminer=" + GetQueryString("Adminer");
    url += "&AdminerSID=" + GetQueryString("AdminerSID");
    url += "&AdminerSID=" + GetQueryString("AdminerSID");
