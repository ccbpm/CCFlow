<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GetTask.aspx.cs" Inherits="CCFlow.AppDemoLigerUI.GetTask" %>
...
<head runat="server">
    ...
    <script src="js/GetTask.js" type="text/javascript"></script>
