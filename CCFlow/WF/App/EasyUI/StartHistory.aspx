<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StartHistory.aspx.cs" Inherits="CCFlow.AppDemoLigerUI.StartHistory" %>
...
<head runat="server">
    ...
    <script src="js/StartHistory.js" type="text/javascript"></script>
    <style type="text/css">
     .imgWFstate{
         height: 17px; 
         width: 19px";
