...
$.extend(
    $.fn, {
        ...
        bitmapCutter: function (settings) {
            ...
            var $generate = $('<a href="javascript:void(0)" class="generate" onfocus="this.blur()" >' + ps.lang.generate + '</a><br/><br/><br/>')
                                        .appendTo($cr);

            var $newimg = $('<img class="jquery-bitmapcutter-newimg" width=40,height=40, alt="32*32" src="" />')
                                        .appendTo($cr).hide();
            var $newimg1 = $('<img class="jquery-bitmapcutter-newimg" width=60,height=60, alt="60*60" src="" />')
                                        .appendTo($cr).hide();
            var $newimg2 = $('<img class="jquery-bitmapcutter-newimg" width=100,height=100, alt="100*100" src="" />')
                                        .appendTo($cr).hide();
                    ...
                    $.ajax({
                        ...
                        success: function (json) {
                            if (json.msg == 'success') {
                                ...
                                $newimg1.attr('src', json.src).show();
                                $newimg2.attr('src', json.src).show();
                                ps.onGenerated("成功！");
                            }
                            else {
                                alert(json.msg);
