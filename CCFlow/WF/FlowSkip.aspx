...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function initComp() {
            $('#<%=TB_SkipToEmp.ClientID%>').autocomplete("FlowSkip.aspx?action=getEmp&key=" + encodeURI($('#<%= TB_SkipToEmp.ClientID%>').val()), {
                max: 10,    //列表里的条目数
...
<body>
    ...
    <div>
        <fieldset>
            ...
            <asp:TextBox ID="TB_SkipToEmp" runat="server" Width="200px"></asp:TextBox> 格式：周天娇(zhoutianjiao)
