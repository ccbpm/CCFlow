<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="CCFlow.WF.FrmTree.Default" %>
    ...
    <script type="text/javascript">
        ...
        var RequestArgs = function () {
          ...
          //  alert('RequestArgsstart ');
            ...
            if (this.FK_Node) {
                while (this.FK_Node.substring(0, 1) == '0')
                    this.FK_Node = this.FK_Node.substring(1);
