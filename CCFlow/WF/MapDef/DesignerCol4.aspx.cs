...
{
    public partial class DesignerCol4 : BP.Web.WebPage
    {
        #region 变量.
        public int idx = 0;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.Pub1.AddTR();
            this.Pub1.AddTD("colspan=4","<div style='float:left' ><img src='../../DataUser/ICON/Smaller.png' border=0/></div><h3><div style='float:center' >" + md.Name + "</div></h3>");
            this.Pub1.AddTREnd();
            #endregion 生成表头.
