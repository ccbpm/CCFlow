<%@ Page Title="开窗返回值PopVal设置" Language="C#" MasterPageFile="../../WinOpen.master" AutoEventWireup="true" CodeBehind="PopVal_Old.aspx.cs" Inherits="CCFlow.WF.MapDef.PopVal_old" %>
