    ...
    if (modalType != undefined) {
        switch (modalType) {
            ...
            case "PackUp_pdf":
                ...
                $('#returnWorkModal').attr('height', 800);
                $('#returnWorkModal').attr('width', 600);
                break;
            case "accepter":
...
function figure_Template_FigureFrmCheck(wf_node) {
    ...
    src += "&r=q" + paras;
    var eleHtml = "<iframe width='100%' height='" + h + "' id='FWC' src='" + src + "' frameborder=0  leftMargin='0'  topMargin='0' scrolling=auto onload='this.height = this.contentDocument.body.clientHeight" + 50 + ";'></iframe>";
    return eleHtml;
}
