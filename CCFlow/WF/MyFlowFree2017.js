...
function figure_Template_FigureFrmCheck(wf_node) {
    ...
    src += "&r=q" + paras;
    var eleHtml = '<div id="FFWC' + wf_node.NodeID + '">' + "<iframe style='width:100%' height=" + h + "' id='FFWC" + wf_node.NodeID + "'    src='" + src + "' frameborder=0  leftMargin='0'  topMargin='0' scrolling=auto onload='this.height = this.contentDocument.body.clientHeight" +50+ ";'></iframe>" + '</div>';
    eleHtml = $(eleHtml);
    eleHtml.css('position', 'absolute').css('top', y).css('left', x).css('width', w).css('height', h);
