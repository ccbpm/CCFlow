...
;!function (t) {
    ...
    var e = document, n = {modules: {}, status: {}, timeout: 10, event: {}}, r = function () {
        this.v = "2.6.6"
    }, o = window.LAYUI_GLOBAL || {}, a = function () {
    ...
    r.prototype.cache = n, r.prototype.define = function (t, e) {
        ...
        var f = this, y = n.dir = n.dir ? n.dir : a, d = e.getElementsByTagName("head")[0];
        t = function () {
        ...
        if (t = t || [], t.constructor === Object) {
            for (n in t) if (o(n, t)) break
        } else for (n = 0; n < t.length && !o(n, t); n++) ;
        return r
...
!function (e) {
    ...
    var t = e.layui && layui.define, a = {
            ...
            ready: function (e) {
                var n = "laydate", l = "", r = (t ? "modules/laydate/" : "theme/") + "default/laydate.css?v=" + i.v + l;
        ...
        }, r = "laydate", o = ".layui-laydate", s = "layui-this", y = "laydate-disabled", d = [100, 2e5],
        m = "layui-laydate-static", c = "layui-laydate-list", u = "layui-laydate-hint", h = "layui-laydate-footer",
        f = ".laydate-btns-confirm", p = "laydate-time-text", g = "laydate-btns-time", v = "layui-laydate-preview",
        T = function (e) {
            var t = this;
    ...
    l.formatArr = function (e) {
        ...
        var e = this, t = e.config, a = e.lang(), n = "static" === t.position, l = e.elem = lay.elem("div", {
            ...
            }), r = e.elemMain = [], o = e.elemHeader = [], s = e.elemCont = [], y = e.table = [],
            d = e.footer = lay.elem("div", {"class": h});
        if (t.zIndex && (l.style.zIndex = t.zIndex), lay.each(new Array(2), function (e) {
            ...
            var n = lay.elem("div", {"class": "layui-laydate-header"}), i = [function () {
                    ...
                    return e.innerHTML = "&#xe65b;", e
                }()], l = lay.elem("div", {"class": "layui-laydate-content"}), d = lay.elem("table"), m = lay.elem("thead"),
                c = lay.elem("tr");
            ...
            }), d.insertBefore(m, d.children[0]), l.appendChild(d), r[e] = lay.elem("div", {"class": "layui-laydate-main laydate-main-list-" + e}), r[e].appendChild(n), r[e].appendChild(l), o.push(i), s.push(l), y.push(d)
        }), lay(d).html(function () {
            var e = [], i = [];
        ...
        i.thisId = t.id, e.remove(T.thisElemDate), n ? t.elem.append(l) : (document.body.appendChild(l), e.position()), e.checkDate().calendar(null, 0, "init"), e.changeEvent(), T.thisElemDate = e.elemID, "function" == typeof t.ready && t.ready(lay.extend({}, t.dateTime, {month: t.dateTime.month + 1})), e.preview()
        ...
        var t, a, n = this, l = (new Date, n.config), r = n.lang(), o = l.dateTime = l.dateTime || n.systemDate(),
            s = n.bindElem || l.elem[0], y = (n.isInput(s) ? "val" : "html", function () {
                if (n.rangeElem) {
        ...
        var u = function () {
            l.range && (n.endDate = n.endDate || lay.extend({}, l.dateTime, function () {
                var e = {}, t = l.dateTime, a = n.getAsYM(t.year, t.month);
        ...
        u(), "string" == typeof y && y ? n.EXP_IF.test(y) ? l.range ? (y = y.split(" " + n.rangeStr + " "), lay.each([l.dateTime, n.endDate], function (e, t) {
            c(t, y[e], e)
        })) : c(o, y) : (n.hint(r.formatError[0] + (l.range ? l.format + " " + n.rangeStr + " " + l.format : l.format) + r.formatError[1]), a = !0) : y && y.constructor === Date ? l.dateTime = n.systemDate(y) : (l.dateTime = n.systemDate(), delete n.startTime, delete n.endDate, u(), delete n.endTime), function () {
            if (n.rangeElem) {
                var e = [n.rangeElem[0].val(), n.rangeElem[1].val()], t = [l.dateTime, n.endDate];
        ...
        var i, l = this, r = l.config, o = {}, s = r[a > 41 ? "endDate" : "dateTime"], d = lay.extend({}, s, t || {});
        ...
        var n, l, r, o = this, y = o.config, t = t ? 1 : 0, m = e || o.thisDateTime(t), c = new Date, u = o.lang(),
            h = "date" !== y.type && "datetime" !== y.type, p = lay(o.table[t]).find("td"),
        ...
        var a = this, n = a.config, i = n.dateTime, l = a.lang(),
            ...
            }), d = a.elemHeader[t], m = lay(d[2]).find("span"), u = a.elemCont[t || 0], h = lay(u).find("." + c)[0],
            v = "cn" === n.lang, T = v ? "\u5e74" : "", D = a.listYM[t] || {}, x = ["hours", "minutes", "seconds"],
        ...
        }), lay(m[v ? 0 : 1]).attr("lay-ym", D[0] + "-" + D[1]).html(D[0] + T); else if ("time" === e) {
            var C = function () {
                lay(o).find("ol").each(function (e, n) {
                    lay(n).find("li").each(function (n, i) {
                        a.limit(lay(i), [{hours: n}, {hours: a[w].hours, minutes: n}, {
                            hours: a[w].hours,
                            minutes: a[w].minutes,
                            seconds: n
        ...
        if (h && u.removeChild(h), u.appendChild(o), "year" === e || "month" === e) lay(a.elemMain[t]).addClass("laydate-ym-show"), lay(o).find("li").on("click", function () {
            ...
            var I = lay.elem("span", {"class": p}), k = function () {
        ...
        var n, i = this, l = i.config, r = i.lang(), o = lay(i.footer).find(f);
        ...
        var e = this, t = e.config;
        if (t.isPreview) {
            var a = lay(e.elem).find("." + v), n = t.range ? e.endDate ? e.parse() : "" : e.parse();
        ...
        var t = this, a = t.config, n = t.thisDateTime(e), i = a.range && ("year" === a.type || "month" === a.type),
            l = t.elemCont[e || 0], r = t.listYM[e], o = function (o) {
                ...
                return s && (r[0] = o ? r[0] - 15 : r[0] + 15, t.list("year", e)), y && (o ? r[0]-- : r[0]++, t.list("month", e)), (s || y) && (lay.extend(n, {year: r[0]}), i && (n.year = r[0]), a.range || t.done(null, "change"), a.range || t.limit(lay(t.footer).find(f), {year: r[0]})), t.setBtnStatus(), s || y
            };
        return {
            prevYear: function () {
...
layui.define("jquery", function (t) {
    ...
    var o = ".layui-nav", r = "layui-nav-item", c = "layui-nav-bar", u = "layui-nav-tree", d = "layui-nav-child",
        y = "layui-nav-child-c", f = "layui-nav-more", h = "layui-icon-down", p = "layui-anim layui-anim-upbit", b = {
            tabClick: function (t, a, s, o) {
                ...
                var t = i(this), a = t.parents(o), n = a.attr("lay-filter"), s = t.parent(), c = t.siblings("." + d),
        ...
        var l = function () {
            ...
            tab: function () {
                ...
                var t = 200, e = {}, s = {}, v = {}, m = "layui-nav-title", C = function (l, o, r) {
                    var c = i(this), h = c.find("." + d);
                    if (o.hasClass(u)) {
                        var b = c.children("." + m);
                        l.css({top: c.offset().top - o.offset().top, height: (b[0] ? b : c).outerHeight(), opacity: 1})
                    } else h.addClass(p), h.hasClass(y) && h.css({left: -(h.outerWidth() - c.width()) / 2}), h[0] ? l.css({
                ...
                i(o + l).each(function (a) {
                    var l = i(this), o = i('<span class="' + c + '"></span>'), y = l.find("." + r);
                    l.find("." + c)[0] || (l.append(o), (l.hasClass(u) ? y.find("dd,>." + m) : y).on("mouseenter", function () {
                        ...
                        var t = i(this), a = (t.parent(), t.siblings("." + d));
        ...
        layui.each(r, function (a, r) {
            var l = r.children && r.children.length > 0,
                ...
                h = i(['<div data-id="' + r.id + '" class="layui-tree-set' + (r.spread ? " layui-tree-spread" : "") + (r.checked ? " layui-tree-checkedFirst" : "") + '">', '<div class="layui-tree-entry">', '<div class="layui-tree-main">', function () {
                    return t.showLine ? l ? '<span class="layui-tree-iconClick layui-tree-icon"><i class="layui-icon ' + (r.spread ? "layui-icon-subtraction" : "layui-icon-addition") + '"></i></span>' : '<span class="layui-tree-iconClick"><i class="icon-folder"></i></span>' : '<span class="layui-tree-iconClick"><i class="layui-tree-iconArrow ' + (l ? "" : c) + '"></i></span>'
                }(), function () {
