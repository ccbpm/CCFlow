            ...
            switch (workFlow.HisGenerWorkFlow.WFState)
            {
                ...
                case WFState.ReturnSta:
                    ...
                    if (rws.Count != 0)
                    {
                        ...
                        {
                            msgInfo += "<fieldset width='100%' ><legend>&nbsp; 来自节点:" + rw.ReturnNodeName + " 退回人:" + rw.ReturnerName + "  " + rw.RDT + "&nbsp;<a href='../DataUser/ReturnLog/" + fk_flow + "/" + rw.MyPK + ".htm' target=_blank>工作日志</a></legend>";
