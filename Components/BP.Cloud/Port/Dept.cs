...
namespace BP.Cloud
{
    ...
    public class Dept : EntityTree
    {
        ...
        protected override bool beforeDelete()
        {
            ...
            if (ensD.Count > 0)
                throw new Exception("err@删除部门错误，该部门岗位下有人员。");
        ...
        protected override bool beforeInsert()
        {
            ...
            try
            {
                ...
                BP.Sys.Base.Glo.WriteUserLog("新建部门:" + this.ToJson(), "组织数据操作");
                return base.beforeInsert();
            }
            catch(Exception e)
            {
                BP.DA.Log.DebugWriteInfo("Insert dept error" + e.Message.ToString());
                throw e;
            }
