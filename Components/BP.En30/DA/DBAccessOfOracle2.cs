...
namespace BP.DA
{
    ...
    /// Oracle 的访问
    /// </summary>
    public class DBAccessOfOracle2
    {
        #region 关于运行存储过程
        ...
        {
            return DBProcedure.RunSP(spName, DBAccessOfOracle2.GetSingleConn);
        }
        /// <summary>
        /// 运行存储过程
        /// </summary>
        ...
        {
            return DBProcedure.RunSP(spName, paras, DBAccessOfOracle2.GetSingleConn);
        }
        ...
        {
            return DBProcedure.RunSPReturnDataTable(spName, DBAccessOfOracle2.GetSingleConn);
        }
        /// <summary>
        /// 运行存储过程
        /// </summary>
        ...
        {
            return DBProcedure.RunSPReturnDataTable(spName, paras, DBAccessOfOracle2.GetSingleConn);
        }
        #endregion
        ...
        public static OracleConnection GetSingleConn
        {
            get
            {
                ...
                {
                    OracleConnection conn = HttpContext.Current.Session["DBAccessOfOracle2"] as OracleConnection;
                    if (conn == null)
                    {
                        conn = new OracleConnection(SystemConfig.AppSettings["DBAccessOfOracle2"]);
                        conn.Open();
                        HttpContext.Current.Session["DBAccessOfOracle2"] = conn;
                    }
                    return conn;
                }
                else
                {
                    OracleConnection conn = SystemConfig.CS_DBConnctionDic["DBAccessOfOracle2"] as OracleConnection;
                    if (conn == null)
                    {
                        conn = new OracleConnection(SystemConfig.AppSettings["DBAccessOfOracle2"]);
                        SystemConfig.CS_DBConnctionDic["DBAccessOfOracle2"] = conn;
                        conn.Open();
                    }
                    else
                    {
        ...
        {
            return DBAccess.RunSQLReturnTable(sql, GetSingleConn, CommandType.Text, SystemConfig.AppSettings["DBAccessOfOracle2"]);
        }
        /// <summary>
        /// 运行sql返回table.
        /// </summary>
        ...
        {
            return DBAccess.RunSQLReturnTable(sql, GetSingleConn, sqlType, SystemConfig.AppSettings["DBAccessOfOracle2"]);
        }
        #endregion
        ...
        {
            return DBAccess.RunSQL(sql, GetSingleConn, CommandType.Text, SystemConfig.AppSettings["DBAccessOfOracle2"]);
        }
        /// <summary>
        /// 运行 SQL
        /// </summary>
        ...
        {
            return DBAccess.RunSQL(sql, GetSingleConn, sqlType, SystemConfig.AppSettings["DBAccessOfOracle2"]);
        }
        #endregion
        ...
        public static float RunSQLReturnFloatVal(string sql, float isNullAsVal)
        {
            ...
            {
                throw new Exception("@执行方法DBAccessOfOracle2.RunSQLReturnFloatVal(sql,isNullAsVal)错误,运行的结果是[" + obj + "].不能向float 转换,请检查sql=" + sql);
            }
        }
        /// <summary>
