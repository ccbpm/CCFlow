...
namespace BP.DA
{
    ...
    public class DBAccess
    {
        ...
        {
            BP.Difference.DBAccess.SaveBytesToDB(bytes,  tableName,  
                tablePK,   pkVal,   saveToFileField);
        }
        /// <summary>
        /// 保存文件到数据库
        /// </summary>
        ...
        {
            BP.Difference.DBAccess.SaveBigTextToDB( docs,  tableName,  tablePK, pkVal, saveToFileField);
        }
        /// <summary>
        /// 保存文件到数据库
        /// </summary>
        ...
        {
            BP.Difference.DBAccess.SaveBigTextToDB(  fullFileName,   tableName,   tablePK,   pkVal,  
                saveToFileField);
        }
        /// <summary>
        /// 从数据库里获得文本
        ...
        {
            return BP.Difference.DBAccess.GetBigTextFromDB(tableName, tablePK, pkVal, fileSaveField);
        }
        /// <summary>
        /// 从数据库里提取文件
        /// </summary>
        ...
        {
            return BP.Difference.DBAccess.GetByteFromDB(  tableName,   tablePK,   pkVal,   fileSaveField);
        }
        #endregion 文件存储数据库处理.
        ...
        public static Paras DealParasBySQL_del(string sql, Paras ps)
        {
        ...
        /// <returns></returns>
        public static string GenerWhereInPKsString_del(string sql)
        {
        ...
        {
            return BP.Difference.DBAccess.GenerSequenceNumber(type);
        }
        /// <summary>
        /// 生成 GenerOIDByGUID.
        /// </summary>
        ...
        {
            return BP.Difference.DBAccess.GenerOIDByGUID(); 
        }
        /// <summary>
        /// 生成 GenerGUID
        /// </summary>
        ...
        {
            return BP.Difference.DBAccess.GenerGUID();
        }
        /// <summary>
        /// 产生一个OID
        /// </summary>
        ...
        {
            return BP.Difference.DBAccess.GenerOID();
        }
        #region 第二版本的生成 OID。
        ...
        {
            return BP.Difference.DBAccess.GenerOID(cfgKey);
        }
        ...
        {
            return BP.Difference.DBAccess.GenerOID(cfgKey, getOIDNum);
        }
         
        public static Int32 GenerOIDByKey32(string intKey)
        {
            return BP.Difference.DBAccess.GenerOIDByKey32(intKey);
        }
        public static Int64 GenerOID(string table, string intKey)
        {
            return BP.Difference.DBAccess.GenerOID(table, intKey);
        }
        #endregion
        ...
        public static int CreatTableFromODBC_del(string selectSQL, string table, string pk)
        {
        ...
        public static int CreatTableFromODBC_del(string selectSQL, string table, string pk1, string pk2)
        {
            DBAccess.RunSQLDropTable(table);
        ...
        public static int CreatTableFromODBC_del(string selectSQL, string table, string pk1, string pk2, string pk3)
        {
            DBAccess.RunSQLDropTable(table);
            string sql = "SELECT * INTO " + table + " FROM OPENROWSET('MSDASQL','" + SystemConfig.AppSettings["DBAccessOfODBC"] + "','" + selectSQL + "')";
            int i = DBAccess.RunSQL(sql);
        ...
        {
            return BP.Difference.DBAccess.RunSQL(sql, paras);
        }
        ...
        {
         return BP.Difference.DBAccess.RunSQL_200705_MySQL(sql, paras);
        }
        private static int RunSQL_200705_Ora(string sql, Paras paras)
        {
            return BP.Difference.DBAccess.RunSQL_200705_Ora(sql, paras);
        }
        /// <summary>
        /// 运行sql
        /// </summary>
        ...
        {
            return BP.Difference.DBAccess.RunSQL_201205_Informix(sql, paras);
        }
        #endregion
        ...
        {
          return  BP.Difference.DBAccess.RunSQLReturnTable(sql, pageSize, pageIdx, key, orderKey, orderType);
        ...
        {
            return BP.Difference.DBAccess.RunSQLReturnTable(sql, paras);
        }
        ...
        {
            return BP.Difference.DBAccess.RunSQLReturnVal(  sql,   paras);
        }
        ...
        {
            return BP.Difference.DBAccess.RunSQLReturnVal(sql, new Paras());
        }
        #endregion
