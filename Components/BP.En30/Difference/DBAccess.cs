    ...
    public class DBAccess
    {
        ...
        public static byte[] GetByteFromDB(string tableName, string tablePK, string pkVal, string fileSaveField)
        {
            if (BP.Sys.SystemConfig.AppCenterDBType == DBType.MSSQL)
            {
                ...
                {
                    if (!DBAccess.IsExitsTableCol(tableName, fileSaveField))
                    {
                        /*如果没有此列，就自动创建此列.*/
        ...
        /// <returns></returns>
        public static Int64 GenerOIDByKey64_del(string intKey)
        {
            Paras ps = new Paras();
        ...
        public static IDbDataAdapter GetAppCenterDBAdapter_del
        {
            get
            {
                switch (AppCenterDBType)
        ...
        public static IDbCommand GetAppCenterDBCommand_del
        {
            get
            {
                switch (AppCenterDBType)
        ...
        public static int RunSQL_del(string sql, SqlConnection conn, string dsn)
        {
        ...
        public static int RunSQL_del(string sql, OracleConnection conn, string dsn)
        {
            return RunSQL(sql, conn, CommandType.Text, dsn);
        }
        ...
        public static int RunSQL_del(string sql, CommandType sqlType, string dsn, params object[] pars)
        {
        ...
        public static int RunSQL_200705_MySQL(string sql)
        {
        ...
        public static Hashtable ConnHTOfMySQL_del
        {
            get
            {
        ...
        /// <param name="paras"></param>
        /// <returns></returns>
        public static int RunSQL_200705_MySQL(string sql, Paras paras)
        {
        ...
        public static int RunSQL_200705_Ora(string sql, Paras paras)
        {
        ...
        /// <param name="sql">sql</param>
        /// <returns>执行结果</returns>
        public static int RunSQL_201205_Informix(string sql)
        {
            return RunSQL_201205_Informix(sql, new Paras());
        }
        public static int RunSQL_201205_Informix(string sql, Paras paras)
        {
            if (paras.Count != 0)
