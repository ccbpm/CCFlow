...
namespace BP.Sys.FrmUI
{
    ...
    public class MapAttrSFTable : EntityMyPK
    {
        ...
        {
            return "/WF/Admin/FoolFormDesigner/MapExt/DDLFullCtrl.htm?FK_MapData=" + this.FK_MapData + "&KeyOfEn=" + this.KeyOfEn + "&MyPK=DDLFullCtrl_"+this.FK_MapData+"_"+ this.KeyOfEn;
        }
        /// <summary>
        /// 设置下拉框显示过滤
        /// </summary>
