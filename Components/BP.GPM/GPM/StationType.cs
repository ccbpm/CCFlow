...
namespace BP.GPM
{
    ...
    public class StationType : EntityNoName
    {
        ...
        public string OrgNo
        {
            get
            {
                return this.GetValStrByKey(BP.Port.StationAttr.OrgNo);
            }
            set
            {
                this.SetValByKey(BP.Port.StationAttr.OrgNo, value);
            }
        }
        public string FK_StationType
        {
            get
            {
                return this.GetValStrByKey(BP.Port.StationAttr.FK_StationType);
            }
            set
            {
                this.SetValByKey(BP.Port.StationAttr.FK_StationType, value);
            }
        }
        ...
        public string FK_StationTypeText
        {
            get
            {
                return this.GetValRefTextByKey(BP.Port.StationAttr.FK_StationType);
            }
        }
