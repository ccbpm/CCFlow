...
namespace BP.PRJ
{
    ...
    public class EmpPrjExts : Entities
    {
        ...
        public System.Collections.Generic.IList<EmpPrjExt> ToJavaList()
        {
            return (System.Collections.Generic.IList<EmpPrjExt>)this;
        }
        /// <summary>
        /// 转化成list
        /// </summary>
        /// <returns>List</returns>
        public System.Collections.Generic.List<EmpPrjExt> Tolist()
        {
            System.Collections.Generic.List<EmpPrjExt> list = new System.Collections.Generic.List<EmpPrjExt>();
            for (int i = 0; i < this.Count; i++)
            {
                list.Add((EmpPrjExt)this[i]);
            }
            return list;
        }
