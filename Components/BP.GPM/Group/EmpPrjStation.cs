...
namespace BP.PRJ 
{
    ...
    public class EmpPrjStations : Entities
    {
        ...
        public System.Collections.Generic.IList<EmpPrjStation> ToJavaList()
        {
            return (System.Collections.Generic.IList<EmpPrjStation>)this;
        }
        /// <summary>
        /// 转化成list
        /// </summary>
        /// <returns>List</returns>
        public System.Collections.Generic.List<EmpPrjStation> Tolist()
        {
            System.Collections.Generic.List<EmpPrjStation> list = new System.Collections.Generic.List<EmpPrjStation>();
            for (int i = 0; i < this.Count; i++)
            {
                list.Add((EmpPrjStation)this[i]);
            }
            return list;
        }
