...
using BP.Cloud;
using BP.Difference;
using SystemConfig = BP.Difference.SystemConfig;
using BP.WF.Port.Admin2Group;
using BP.OrgIntegration;

namespace BP.Port.QiYeWeiXin
{
    public class Glo
    {
        /// <summary>
        ...
        public static string MainBuess(XmlDocument xd)
        {
            ...
            if (infoType.Equals("suite_ticket"))
            {
                ...
                BP.DA.Log.DebugWriteInfo("接收ticket信息,时间：" + DataType.CurrentDateTime + ";suitTicket:" + suitTicket);
            ...
            if (infoType.Equals("create_auth"))
            {
                ...
                try
                {
                    ...
                    return BP.Port.QiYeWeiXin.Glo.InstallIt(authCode);
                }
                catch (Exception ex)
                {
            ...
            if (infoType.Equals("change_contact"))
            {
                ...
                int i = org.Retrieve(Cloud.OrgAttr.CorpID, corpID);
                if (i == 0)
                ...
                switch (changeType)
                {
                    case "create_user": //新建成员
                        return BP.Port.QiYeWeiXin.Glo.changeConCreateUser(xd, org);
                    case "update_user": //变更成员信息
                        return BP.Port.QiYeWeiXin.Glo.changeConUpdateUser(xd, org);
                    case "delete_user": //删除成员
                        return BP.Port.QiYeWeiXin.Glo.changeConUpdateUser(xd, org);
                    case "create_party": //新增部门
                        return BP.Port.QiYeWeiXin.Glo.changeConCreateDept(xd, org);
                    case "update_party": //更新部门
                        return BP.Port.QiYeWeiXin.Glo.changeConUpdateDept(xd, org);
                    case "delete_party": //删除部门
                        return BP.Port.QiYeWeiXin.Glo.changeConDelDept(xd, org);
                    default:
        ...
        public static Dictionary<string, object> getSuitAccessToken_S()
        {
            ...
            parameters.Add("suite_id", HttpUtility.UrlEncode(BP.Port.QiYeWeiXin.Glo.SuiteID));//应用suiteId
            parameters.Add("suite_secret", HttpUtility.UrlEncode(BP.Port.QiYeWeiXin.Glo.SuiteID_Secret));//应用suiteSecret
            parameters.Add("suite_ticket", BP.Port.QiYeWeiXin.Glo.Suite_ticket);//suite_ticket
            BP.DA.Log.DebugWriteInfo("suite_ticket" + BP.Port.QiYeWeiXin.Glo.Suite_ticket);
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty((string)dd["suite_access_token"]))
                {
                    ...
                    BP.DA.Log.DebugWriteError("err@获取SuitAccessToken错误，参数为：SuiteID:" + BP.Port.QiYeWeiXin.Glo.SuiteID + "SuiteID_Secret:" + BP.Port.QiYeWeiXin.Glo.SuiteID_Secret + "Suite_ticket:" + BP.Port.QiYeWeiXin.Glo.Suite_ticket);
                }
        ...
        /// </summary>
        /// <returns></returns>
        public static string getAccessToken(Cloud.Org org, string permanentCode)
        {
            //获取第三方应用凭证
            string suitAccessToken = getSuitAccessToken();
        ...
        public static string getProviderAccessToken()
        {
            ...
            IDictionary<string, string> parameters = new Dictionary<string, string>();
            parameters.Add("corpid", BP.Port.QiYeWeiXin.Glo.CorpID);
            parameters.Add("provider_secret", BP.Port.QiYeWeiXin.Glo.ProviderSecret);
        ...
        public static void createDept(Cloud.Org org, string permanentCode)
        {
        ...
        public static string CreateEmp(Cloud.Org org, string id, BP.Cloud.Dept dept)
        {
            //构造url。
    ...
    */
                ...
                if (emp.RetrieveFromDBSources() == 0)
                {
                    ...
                    emp.DeptNo = org.No + "_" + main_department;
                    //如果主部门是部门的根目录.
    ...
    */
                        ...
                        {
                            de.DeptNo = org.No + "_" + deptNo.Trim();
                        }

                        de.EmpNo = emp.UserID; //使用userID.
                        de.MyPK = org.No + "_" + deptNo.Trim() + "_" + de.EmpNo;
        ...
        /// 取得标签列表
        /// </summary>
        public static void createTag(Cloud.Org org)
        {
            //构造url。
        ...
        /// <returns></returns>
        public static string Install_CheckHaveDeptRoot(Cloud.Org org, JToken authInfoJtoken)
        {
           ...
           BP.Cloud.Emp emp = new BP.Cloud.Emp();
            ...
            //增加管理员.
            OrgAdminers admins = new OrgAdminers();
            admins.Retrieve("OrgNo", org.No);
            foreach (OrgAdminer admin in admins)
            {
                if (emp.IsExit("OrgNo", org.No, "UserID", admin.EmpNo) == true)
                    continue;

                emp.DeptNo = org.No;
                emp.Name = admin.EmpNo;
                emp.No = admin.EmpNo;
                ...
                DeptEmp de = new DeptEmp();
                de.OrgNo = emp.OrgNo;
                de.DeptNo = emp.DeptNo;
                de.EmpNo = emp.UserID;
                de.MyPK = emp.DeptNo + "_" + de.EmpNo;
                de.EmpNo = emp.No;
        ...
        /// <param name="org"></param>
        /// <returns></returns>
        public static string changeConCreateUser(XmlDocument xd, BP.WF.Port.AdminGroup.Org org)
        {
            ...
            if (emp.RetrieveFromDBSources() == 0)
            {
                ...
                foreach (string str in strs)
                {
                    ...
                    DeptEmp de = new DeptEmp();
                    de.DeptNo = org.No + "_" + str;
                    de.EmpNo = emp.No;
                    de.MyPK = de.DeptNo + "_" + de.EmpNo;
                    de.OrgNo = org.No; //组织信息.
                    de.Insert();
                }
                emp.DeptNo = org.No + "_" + MainDepartment;
                emp.OrgNo = org.No;
                emp.Insert();
            }
            else
        ...
        /// <param name="xd"></param>
        /// <param name="org"></param>
        public static string changeConUpdateUser(XmlDocument xd, BP.WF.Port.AdminGroup.Org org)
        {
            string userID = xd.FirstChild["UserID"].InnerText;//成员UserID、变更信息的成员UserID
        ...
        /// <param name="xd"></param>
        /// <param name="org"></param>
        public static string changeConDeleteUser(XmlDocument xd, BP.WF.Port.AdminGroup.Org org)
        {
            string userID = xd.FirstChild["UserID"].InnerText;//成员UserID、变更信息的成员UserID
            if (BP.DA.DataType.IsMobile(userID) == false)
        ...
        /// <param name="xd"></param>
        /// <param name="org"></param>
        public static string changeConCreateDept(XmlDocument xd, BP.WF.Port.AdminGroup.Org org)
        {
        ...
        /// <param name="xd"></param>
        /// <param name="org"></param>
        public static string changeConUpdateDept(XmlDocument xd, BP.WF.Port.AdminGroup.Org org)
        {
            string id = xd.FirstChild["Id"].InnerText;//部门Id
            string parentId = xd.FirstChild["ParentId"].InnerText;//父部门id
        ...
        /// <param name="xd"></param>
        /// <param name="org"></param>
        public static string changeConDelDept(XmlDocument xd, BP.WF.Port.AdminGroup.Org org)
        {
            string id = xd.FirstChild["Id"].InnerText;//部门Id
            string parentId = xd.FirstChild["ParentId"].InnerText;//父部门id
            if (parentId.Equals("0") == true)
        ...
        public static void Insert_Port_Org(Cloud.Org org, JToken authCorpInfoJtoken, string corpId, string permanentCode, string accessToken, JToken authUserInfo)
        {
            ...
            BP.DA.Log.DebugWriteInfo("安装应用时间：" + DataType.CurrentDateTime + ";企业简称:" + org.Name + ";企业全称:" + org.NameFull + ";企业所在地信息:"
                + org.Location + ";企业类型:" + org.SubjectType);

            org.No = Cloud.Org.GenerNewOrgNo();
        ...
        /// <param name="org"></param>
        public static void InsertPort_OrgAdminer(string corpId, string agentid, string suitAccessToken, Cloud.Org org)
        {
            IDictionary<string, string> parametersAdm = new Dictionary<string, string>();
            ...
            {
                //插入Port_OrgAdminer中
                OrgAdminer orgAdminer = new OrgAdminer();
                ...
                foreach (Newtonsoft.Json.Linq.JToken item in jArray.Children())
                {
                    orgAdminer = new OrgAdminer();
                    orgAdminer.EmpNo = item["userid"].ToString();//管理员
        ...
        public static void SendMsg(string sender, string toUserIDs, string title, string docs, string url, string orgNo)
        {
                ...
                Convert.ToDateTime(org.AccessTokenExpiresIn)) > 0)
            {
                ...
                //如果失效了，就直接更新一下.
              BP.Cloud.HttpHandler.App_Org handler = new BP.Cloud.HttpHandler.App_Org();
