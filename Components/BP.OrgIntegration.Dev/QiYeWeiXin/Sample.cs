...
namespace MsgCryptTest
{
    class Sample
    {
        static void Main(string[] args)
        {
            ...
            string sToken = "vkgs8rv7TWg3";
            string sCorpID = "wx8eac6a18c5efec30";
            string sEncodingAESKey = "tnzdpTX9BpqG2fad8oQHbou9KLjpDPelivp2qUflGeo";
			...
			*/
            ...
            //sxx
            string data = BP.DA.DataType.ReadURLContext("http://ccc.cflow.org.", 1000);
