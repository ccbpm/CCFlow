...
namespace BP.WF.CCBill
{
    ...
    public class FrmStationCreate : EntityMM
    {
        ...
        public int FK_Bill
        {
            get
            {
                return this.GetValIntByKey(FrmStationCreateAttr.FK_Bill);
            }
            set
            {
                this.SetValByKey(FrmStationCreateAttr.FK_Bill, value);
            }
        }
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AddTBStringPK(FrmStationCreateAttr.FK_Bill, null, "表单", true, true, 1, 100, 100);
    ...
    public class FrmStationCreates : EntitiesMM
    {
        ...
        public FrmStationCreates(int nodeID)
        {
            ...
            qo.AddWhere(FrmStationCreateAttr.FK_Bill, nodeID);
            qo.DoQuery();
        }
        /// <summary>
        /// 单据可创建的工作岗位
