    ...
    public class CtrlModel : BP.En.EntityMyPK
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AttrsOfOneVSM.AddBranchesAndLeaf(new BP.CCBill.Template.CtrlModelDtls(), new BP.Port.Emps(),
                    CtrlModelDtlAttr.FrmID,
                    CtrlModelDtlAttr.IDs, "权限按照绑定的岗位", "FK_StationType", EmpAttr.Name, EmpAttr.No);

                //权限设置绑定人员. 使用树杆与叶子的模式绑定.
                map.AttrsOfOneVSM.AddBranchesAndLeaf(new BP.CCBill.Template.CtrlModelDtls(), new BP.Port.Emps(),
                   CtrlModelDtlAttr.FrmID,
                   CtrlModelDtlAttr.IDs, "权限按照绑定的人员", EmpAttr.FK_Dept, EmpAttr.Name, EmpAttr.No, "@WebUser.FK_Dept");
