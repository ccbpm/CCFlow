...
namespace BP.WF
{
    ...
    public class Dev2Interface
    {
        ...
        public static int Todolist_EmpWorks
        {
            get
            {
                //Flow flow = new Flow("111");
                //WorkNode wn = new WorkNode(123, 2301);
                //FindWorker fw = new FindWorker();
                //DataTable dt = fw.DoIt(flow, wn, wn);
