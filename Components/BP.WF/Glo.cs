...
namespace BP.WF
{
    ...
    public class Glo
    {
        ...
        /// </summary>
        public static void GenerInstancePacketOfData(string flowNo, Int64 workid)
        {
            string path = SystemConfig.PathOfDataUser + "\\InstancePacketOfData\\" + flowNo + "\\";
            ...
            //字段集合.
            MapAttrs attrs = new MapAttrs("ND" + int.Parse(flowNo + "01"));
            ...
            //模版文件.
            string docs = BP.DA.DataType.ReadTextFile(SystemConfig.PathOfDataUser + "\\InstancePacketOfData\\Template.htm");
            docs = docs.Replace("@FrmInfo", frmInfo.ToString());

            string file = SystemConfig.PathOfDataUser + "\\InstancePacketOfData\\" + flowNo + "\\" + workid + ".htm";
