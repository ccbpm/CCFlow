...
namespace BP.WF.HttpHandler
{
    ...
    public class WF_Admin_FoolFormDesigner_MapExt : DirectoryPageBase
    {
        ...
        /// </summary>
        /// <returns></returns>
        public string Link_Save()
        {
            try
            {
                MapExt me = new MapExt();
                int i = me.Retrieve(MapExtAttr.ExtType, MapExtXmlList.Link,
                    MapExtAttr.FK_MapData, this.FK_MapData,
                    MapExtAttr.AttrOfOper, this.KeyOfEn);
                ...
                //url.
                me.Doc = this.GetValFromFrmByKey("TB_Url"); //要执行的SQL.

                //宽度，高度.
                me.W = this.GetValIntFromFrmByKey("TB_Width"); //宽度.
                me.H = this.GetValIntFromFrmByKey("TB_Height"); //高度.

                me.ExtType = MapExtXmlList.Link;
        ...
        {
            MapExt me = new MapExt();
            me.Delete(MapExtAttr.ExtType, MapExtXmlList.Link,
                MapExtAttr.FK_MapData, this.FK_MapData,
                MapExtAttr.AttrOfOper, this.KeyOfEn);

            return "删除成功.";
        }
        public string Link_Init()
        {
            // 加载 mapext 数据.
            MapExt me = new MapExt();
            int i = me.Retrieve(MapExtAttr.ExtType, MapExtXmlList.Link,
