    ...
    public class WF_Comm : DirectoryPageBase
    {
        ...
        public string Entities_Save()
        {
            try
            {
                ...
                //没有新增行
                if (this.GetRequestValBoolen("InsertFlag") == false || (en.EnMap.IsAutoGenerNo == true && DataType.IsNullOrEmpty(newPKVal) == true))
                    return "更新成功.";
