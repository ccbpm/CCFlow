    ...
    public class MapFrmWps : EntityNoName
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AddMyFile("wps文件模板", null, SystemConfig.PathOfDataUser + "\\CyclostyleFile\\");
        ...
        {
            string url = "../../Admin/FoolFormDesigner/CCForm/Frm.htm?FK_MapData=" + this.No + "&UserNo=" + BP.Web.WebUser.No + "&SID=" + Web.WebUser.SID + "&AppCenterDBType=" + DBAccess.AppCenterDBType + "&CustomerNo=" + SystemConfig.CustomerNo;
            return url;
        }
        /// <summary>
        /// 设计Wps表单
        ...
        {
            string url = "../../Admin/FoolFormDesigner/Designer.htm?FK_MapData=" + this.No + "&UserNo=" + BP.Web.WebUser.No + "&SID=" + Web.WebUser.SID + "&IsFirst=1&AppCenterDBType=" + DBAccess.AppCenterDBType + "&CustomerNo=" + SystemConfig.CustomerNo;
            return url;
        }
        /// <summary>
        /// 查询
