...
namespace BP.WF.XML
{
    ...
    /// 管理员
    /// </summary>
    public class AdminMenuCloudGroup : XmlEn
    {
        #region 属性
        public string No
        {
        ...
        public override XmlEns GetNewEntities
        {
            get
            {
                return new AdminMenuCloudGroups();
            }
        }
        #endregion
    ...
    /// 
    /// </summary>
    public class AdminMenuCloudGroups : XmlEns
    {
        #region 构造
        /// <summary>
        /// 考核率的数据元素
        /// </summary>
        public AdminMenuCloudGroups() { }
        #endregion
        ...
        public override XmlEn GetNewEntity
        {
            get
            {
                return new AdminMenuCloudGroup();
            }
        }
