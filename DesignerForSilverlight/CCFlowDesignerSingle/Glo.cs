        ...
        public static void OpenWinByDoType(string lang, string dotype, string fk_flow, string node1, string node2)
        {
            ...
            switch (dotype)
            {
                ...
                case UrlFlag.FrmLib:
                    ...
                    Glo.OpenWindow(Glo.BPMHost + url, "执行", 800, 760);
                    return;
                ...
                case UrlFlag.Dir: // 方向条件。
                    url = "/WF/Admin/Cond/ConditionLine.htm?FK_Flow=" + fk_flow + "&FK_MainNode=" + node1 + "&FK_Node=" + node1 + "&ToNodeID=" + node2 + "&CondType=2&Lang=CH";
