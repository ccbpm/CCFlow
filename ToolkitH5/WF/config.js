...
// 运行平台 .net版本请设置CCFlow, java 版本请设置JFlow.
var plant = "CCFlow";
...
var ccbpmHostDevelopAPI = host + "/DataUser/DevelopAPI.ashx";  // For .net版本的CCFlow.
//var ccbpmHostDevelopAPI = host + "/DataUser/DevelopAPI/ProcessRequest"; //For .java版本的JFlow.
