...
namespace BP.VSTO
{
	...
	public class Glo
	{
		...
		/// </summary>
		/// <returns></returns>
		public static BP.VSTO.CCForm.CCFormAPISoapClient GetCCFormAPISoapClient()
		{
			...
			var ctor =
                typeof(BP.VSTO.CCForm.CCFormAPISoapClient).GetConstructor(
				new Type[] {
					typeof(Binding), 
					typeof(EndpointAddress)
				});
            return (BP.VSTO.CCForm.CCFormAPISoapClient)ctor.Invoke(
