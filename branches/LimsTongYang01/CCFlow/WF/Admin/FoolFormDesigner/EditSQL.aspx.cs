    ...
    public partial class Comm_MapDef_EditSQL : BP.Web.WebPage
    {
        ...
        public void BindTable(MapAttr mapAttr)
        {
            ...
            if (mapAttr.UIBindKey.Contains("."))
                this.Pub1.AddTD("<a href=\"javascript:WinOpen('../Comm/Search.htm?EnsName=" + mapAttr.UIBindKey + "','df');\" >打开</a>");
            else
                this.Pub1.AddTD("<a href=\"javascript:WinOpen('SFTableEditData.htm?FK_SFTable=" + mapAttr.UIBindKey + "','df');\" >打开</a>");
            this.Pub1.AddTREnd();
