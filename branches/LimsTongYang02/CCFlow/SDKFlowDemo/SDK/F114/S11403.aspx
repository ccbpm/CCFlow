<%@ Page Title="合流点" Language="C#" MasterPageFile="~/SDKFlowDemo/SDK/Site.Master" AutoEventWireup="true" CodeBehind="S11403.aspx.cs" Inherits="CCFlow.SDKFlowDemo.SDK.F114.S11403" %>
...
<%@ Register src="../../../WF/SDKComponents/ThreadDtl.ascx" tagname="ThreadDtl" tagprefix="uc4" %>

<%@ Register src="../../../WF/SDKComponents/FrmCheck.ascx" tagname="FrmCheck" tagprefix="uc5" %>

<%@ Register src="../../../WF/SDKComponents/FrmCheck.ascx" tagname="FrmCheck" tagprefix="uc6" %>
...
<legend>多附件-组件</legend>
    ...
    子线程运行情况:
    <uc4:ThreadDtl ID="ThreadDtl1" runat="server" />

    
<fieldset>
<legend>审核组件</legend>
<uc6:FrmCheck ID="FrmCheck1" runat="server" />
</fieldset>
