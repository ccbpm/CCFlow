## 版本升级公告: 
 1. 该版本是vs2010版本，支持.net4.0. 我们在2019年8月11号停止该版本的升级,我们将提供.net4.5 for vs2017,vs2019的版本.
 2. 新版本的 .net 4.5下载地址为 https://gitee.com/opencc/ccflow  svn://gitee.com/opencc/ccflow
 3. 该版本服役了10年零2个月, 感谢各位客户、朋友、爱好着的一路相伴，是您们见证了ccflow的成长.
 4. 对于ccflow的客户,遇到的问题请反馈给我们相关技术支持人员，我们将一如既往的为您提供技术支持，如果您想升级到.net core版本，或者 .net 4.5版本，我们会提供帮助.
 5. 我们推荐使用.net core 版本下载地址. https://gitee.com/opencc/CCFlowForNetcore
 6. 更多的java,c# 版本下载请参考 http://ccflow.org/Down.htm
     特此通知  济南驰骋信息技术有限公司 2019年8月.
...
08. ccbpm不仅仅能够满足中小企业的需要，也能满足通信级用户的应用，先后在西门子、海南航空、中船、山东省国土资源厅、华电国际、江苏山东吉林测绘院、厦门证券、天业集团、天津港等国内外大型企业政府单位服役。
09. ccbpm可以独立运行，也可以作为中间件嵌入您的开发架构,还可以作为服务的模式支持对外发布.
10. ccbpm 既有配置类型的开发适用于业务人员，IT维护人员， 也有面向程序员的高级引擎API开发,满足不同层次的流程设计人员需要.
11. 支持 oracle,sqlserver,mysql,pg 数据库. 内置:
...
数据库安装脚本请移步：https://gitee.com/opencc/JFlow/wikis/pages    
