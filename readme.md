...
13. D:\ccflow.git\CCFlow\WF\WAP -- 手机访问前台代码目录. (说明:对C级用户有效)
14. D:\ccflow.git\CCFlow\WF -- ccflow前台应用程序层(主要的功能都是在这个目录里面)
15. D:\ccflow.git\CCFlow\WF\Admin - 对ccflow的管理比如设计方向条件.报表定义...
16. D:\ccflow.git\CCFlow\WF\Admin\XAP CCFlowDesigner.xap流程设计器，CCForm.xap表单设计器。   
17. D:\ccflow.git\CCFlow\WF\MapDef - 表单定义.
...
14. 在mysql,oracle的安装的时候会越到大小写敏感问题,我们需要被安装的mysql数据库不要区分大小写.
