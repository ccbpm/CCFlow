...
{
    public partial class Cell3D : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //第1维度.
            BP.Port.Depts ens1 = new BP.Port.Depts();
            ens1.RetrieveAll();
            ...
            //第3维度.
            BP.Pub.YFs ens3 = new BP.Pub.YFs();
            ens3.RetrieveAll();
            #endregion  组织维度数据源.
            ...
            #region  输出维度1
            this.Pub1.AddTR();
            this.Pub1.AddTDTitle("rowspan=2","表头");
            foreach (BP.Port.Dept en1 in ens1)
            {
                int numOfD2 = ens2.GetCountByKey(BP.Port.EmpAttr.FK_Dept, en1.No);
                if (numOfD2 == 0)
                    continue; // 如果没有数据源就continue.

                this.Pub1.AddTDTitle("colspan=" + numOfD2,en1.Name);
            }
            this.Pub1.AddTREnd();
            #endregion  输出维度1
            ...
            #region  输出表体
            foreach (BP.Port.Dept en2 in ens1)
            {
