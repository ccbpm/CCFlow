<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Top.aspx.cs" Inherits="CCFlow.WF.App.GuestApp.Top" %>
...
<body>
    <div class="top">
        <div class="logo">外部用户业务处理门户</div>
        <div class="logo_cz">
            <div class="logo_cz1">
                <ul>
                    <li>账号：<%=BP.Web.GuestUser.No %></li>
                    <li>名称：<%=BP.Web.GuestUser.Name%></li><br />
                </ul>
            </div>
            <div class="logo_cz2">
                <ul>
