<%@ Page Title="表单权限" Language="C#" MasterPageFile="../FoolFormDesigner/WinOpen.master" AutoEventWireup="true" CodeBehind="Sln.aspx.cs" Inherits="CCFlow.WF.MapDef.Sln" %>
<%@ Register src="../FoolFormDesigner/Pub.ascx" tagname="Pub" tagprefix="uc1" %>
