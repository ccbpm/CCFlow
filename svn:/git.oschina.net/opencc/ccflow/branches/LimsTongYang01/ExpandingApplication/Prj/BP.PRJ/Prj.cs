    ...
    public class Prj : EntityNoName
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AddDDLEntities(PrjAttr.FK_Dept, null, "隶属部门", new Port.Depts(), true);
        ...
        {
           BP.Sys.PubClass.WinOpen("/PRJ/NodeAccess.aspx?FK_Prj=" + this.No, 500, 500);
            return null;
        }
        public string DoEmpPrjStations()
        {
            PubClass.WinOpen("/WF/Comm/Search.aspx?EnsName=BP.PRJ.EmpPrjExts&FK_Prj=" + this.No, 800, 500);
            return null;
        }
